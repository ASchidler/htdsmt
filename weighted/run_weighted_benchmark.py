...
def run_portfolio(c_instance, weighted):
    lb = None
    res = solver.solve(c_instance, htd=False, sb=False, heuristic_repair=True, clique_mode=0,
                       weighted=weighted)
